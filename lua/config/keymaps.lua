...
-- github control cmds
vim.api.nvim_set_keymap("", "<leader>prc", ":ToggleTerm gh pr create<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("", "<leader>prr", ":ToggleTerm gh dash pr<CR>", { noremap = true, silent = true })
